CREATE TYPE "public"."tiers" AS ENUM('Free', 'Basic', 'Standard', 'Premium');--> statement-breakpoint
...
CREATE INDEX "products.clerk_user_id_idx" ON "products" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscriptions.clerk_user_id_idx" ON "user_subscriptions" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscriptions.stripe_customer_id_idx" ON "user_subscriptions" USING btree ("stripe_customer_id");