        ...
        <DialogContent className="max-w-max">
            <DialogHeader>
                ...
                <DialogDescription>
                    ...
                    your site and your
                    customers will start seen PPP discounts!
                </DialogDescription>
            </DialogHeader>
            <pre className="mb-4 overflow-x-auto p-4 bg-secondary rounded 
                max-w-screen-xl text-secondary-foreground">
                <code>
                    {code}
                </code>
            </pre>
